"""
Class Fibo - класс позволяющий перебирать числа фибоначи, с встроенным итератором.
"""
...
print(next(prime_gen),next(prime_gen)) # Чтобы показать, что дальше итерируется
